This is the source code that will soon power "toolmantim.com":http://toolmantim.com/. It's a simple Sinatra application serving up haml-based articles from disk.
...
The following directories and their contents are Copyright Tim Lucas. You may not reuse anything therein without my permission:
